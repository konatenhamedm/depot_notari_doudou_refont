...
class CourierInterneController extends BaseController
{
    ...
    /**
     * @Route("/archive/{id}/interne", name="courierArrive_archive", methods={"GET"})
     * @param $id
     * @param CourierArriveRepository $repository
     * @return Response
     */
    #[Route('/archive/{id}/interne', name: 'courierArrive_archive', methods: ['GET', 'POST'])]
    ...
    public function accuse(Request $request, CourierArrive $courierArrive, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('courrier/interne/accuse.html.twig', [
